...
export default function block() {
  ...
  return (
    <>
      <div className="px-4 md:px-0 mb-20 max-w-[1000px]  mx-auto">
        <form>
          <div className="md:grid md:grid-cols-[1fr_2fr] md:gap-12">
              ...
              <div className="max-w-[300px] ml-auto">
                <div className="mt-2">
                  <div
                    ...
                    className=" flex  space-x-4 w-full rounded-xl bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                  >
                    <img src={Map} alt="" className="w-8 h-10 object-contain" />

                    <div>
                      <p>Theme</p>
                      <p className="text-black font-600">Minimalist</p>
                    </div>
                  </div>
                  <label
                    htmlFor="videoUpload"
            ...
            <div className="max-w-[500px]">
              ...
              <MoreOptions />
              <Link to={'/event:id'}>
                <button className="bg-black text-white w-40 py-2 rounded-xl mt-5">
                  Create Event
                </button>
              </Link>
            </div>
