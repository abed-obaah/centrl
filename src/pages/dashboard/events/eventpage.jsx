...
import Brain from '../../../assets/brains.png'
...
const EventPage = () => {
  ...
  return (
    <div className="bg-eventBg min-h-screen text-white p-8 flex justify-center items-center ">
          <div className="flex flex-col md:flex-row space-x-10 w-full max-w-[900px] justify-center mt-28 ">
                      ...
                      <div className="w-full">
                          ...
                          <div className="flex items-start space-x-3 items-center mt-6">
                            ...
                            <div className="flex items-center space-x-3">
                              <p className="text-50 font-500 text-left">Lil Wayne</p>
            ...
            <div className="flex flex-col text-left md:text-left">
              <h1 className="text-800 font-bold">Love Boulevard</h1>
              ...
              >
                <div className="rounded-lg">
                  ...
                  <div className="flex items-center mt-5 px-9 space-x-3">
                    ...
                    <p className="text-200 font-500 text-white">$50 - $250</p>
                  </div>
              ...
              <div className="w-full max-w-[550px] mt-20">
                <h2 className="text-50 font-500 border-b pb-10 border-b-black">About Event</h2>
              ...
              <div className="bg-[#cfb8b6] h-64 w-40 rounded-[23px] relative overflow-hidden">
                  <img src={LilWayne} alt="Event" className="h-64 p-1 rounded-[23px] object-cover" />
