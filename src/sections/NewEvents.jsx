...
// Skeleton Loading Component that matches your exact UI
const EventCardSkeleton = () => {
  return (
    <div className="bg-card rounded-lg flex flex-col h-full w-full max-w-[300px] mx-auto animate-pulse">
      ...
      <div className="flex-grow flex flex-col p-4 justify-between h-full">
        <div>
                ...
                <div className="flex flex-grow flex-col p-4 justify-between h-full">
                  <div>
                    ...
                    <div className="mb-2">
                      ...
                      <p className="text-100 text-black/50 truncate">
