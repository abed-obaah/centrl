  ...
  return (
    <div className="fixed z-[600]  inset-0  flex items-center justify-center ">
      <div
        ...
        onClick={onClose}
      />
      <div className="bg-white z-[800]  rounded-lg w-full max-w-[500px] mx-4">
        ...
        <form onSubmit={handleSubmit} className="p-4">
          <div className="flex items-center px-3 py-2 justify-between border border-[#000]/15 rounded-tl-full rounded-bl-full  mb-10">
