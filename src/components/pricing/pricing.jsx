  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="absolute top-[10em] left-[25em]">
        <img src={Min} alt="Diamond" className="w-[10em] h-34" />
      </div>
      ...
      <div className="absolute bottom-[50%] right-[25em]">
        <img src={Min} alt="Star" className="w-44 h-34" />
      </div>
      <Header />
      {/* Pricing Section */}
                ...
                <span
                  className={classNames(
                    tier.id === 'tier-freelancer'
                      ? 'text-white bg-black rounded-sm p-1'
                      : 'text-gray-900 bg-[#E7D1FF] p-1', // Example: Green for first card, Blue for second
