     ...
     <div className="bg-white w-[400px] rounded-xl border border-[#000]/15 px-6 py-4">
      <div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full text-200 mt-8 rounded-lg bg-gradient-to-r from-[#CD2574] to-[#E46708] hover:from-[#E46708] hover:to-[#CD2574] px-6 py-2.5  font-700 text-black  transition-all duration-300 ease-in-out"
          >
           Continue with Email
          </button>
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center rounded-lg bg-gradient-to-r from-[#0000004D] to-[#0000001A] hover:from-[#0000001A] hover:to-[#0000004D] px-6 py-2.5 font-bold text-muted50 transition-all duration-300 ease-in-out"
            >
