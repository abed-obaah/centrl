  ...
  return (
    <>
      <div className="min-h-full">
        ...
        <div className="py-10">
          <div className="mx-auto max-w-3xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-12 lg:gap-8 lg:px-8 mr-14">
             < Aside />
