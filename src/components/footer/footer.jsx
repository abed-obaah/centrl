import ArrowwLeft from '../../assets/app.png'
import ArrowwLefts from '../../assets/play.png'
      ...
      />
            ...
            <div className='flex gap-4'>
                        <img
                            src={ArrowwLeft}
                            alt="Arrow Left"
                            className="w-40 h-auto" // Adjust the width, height will auto-scale
                            style={{ objectFit: "contain" }} // Ensures the image is not stretched
                            />
                        <img
                            src={ArrowwLefts}
                            alt="Arrow Left"
          ...
          <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-lg text-black md:order-1 md:mt-0">
              CENTRL.
            </p>
          </div>
        </div>
