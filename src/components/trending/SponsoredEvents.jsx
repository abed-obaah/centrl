...
import Feels from "../../assets/ravebeach.png";
import Wave from "../../assets/wave.png";
import Groove from "../../assets/evengate.png";
import Eko from "../../assets/day.png";
import Danfo from "../../assets/danfo.png";
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="flex justify-between items-center w-full max-w-7xl mb-4 px-4">
        <h2 className="text-2xl font-medium">Sponsored Events</h2>
