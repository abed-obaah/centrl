...
const TrendingEvents = () => {
  return (
    <div className="bg-[#F6F6F6]">
      <div className="overflow-hidden rounded-lg bg-white shadow-sm max-w-[76rem] mx-auto mt-10 mb-20">
        <div className="px-80 py-5 sm:p-6">
          <div className="flex justify-between items-center">
            <h1 className="text-lg font-semibold">Calendars</h1>
            <input
              type="text"
              placeholder="Search"
              className="border rounded-md px-3 py-2 w-1/4 sm:w-1/5"
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center ">
        {/* Section Header */}
        <div className="flex justify-between items-center w-full max-w-[77rem] mb-4 px-4">
          ...
          {cards.map((card) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-[15px] text-[#B0B0B0] font-normal">
                  {card.description}
                </p>
              </div>
            </div>
