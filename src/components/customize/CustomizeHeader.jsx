...
() {
  return (
    <div
    className="flex items-center gap-80  px-56 py-5 fixed top-0 left-0 z-[500] w-full backdrop-blur-md bg-gradient-to-r from-white/50 via-neutral-100/50 to-white/50  supports-[backdrop-filter]:bg-white/3">
  <Link
    to="/admin-themes"
